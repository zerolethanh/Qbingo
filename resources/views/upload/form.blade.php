          ...
          <form class="form-horizontal" role="form" method="POST" action="{{ url('/upload') }}"
            ...
            <div class="form-group">
              ...
              <div class="col-md-12 text-center">
                <button id="confirm_screen_button" type="submit" class="btn btn-primary" data-toggle="modal"
                        data-target="#confirm_upload_modal">
                  確認画面へ
                </button>
              </div>
            </div>
...
//        userPhotoPreview('confirm_user_photo_preview');
  ...
  function checkFormIsValid() {
    var check_el_ids = ['user_name', 'user_sex', 'user_message'];
